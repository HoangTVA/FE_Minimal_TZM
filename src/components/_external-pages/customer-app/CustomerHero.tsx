...
import { ContentStyle, HeroImgStyle, HeroOverlayStyle, RootStyle } from './Customer.styles';
      ...
      <RootStyle initial="initial" animate="animate" variants={varWrapEnter}>
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <motion.div variants={varFadeInRight}>
              <Typography>
                Tùy chỉnh theo nhu cầu kinh doanh của bạn và dễ dàng tích hợp với Hệ sinh thái của bạn để đạt được sự hài lòng của khách hàng.
              </Typography>
            </motion.div>
